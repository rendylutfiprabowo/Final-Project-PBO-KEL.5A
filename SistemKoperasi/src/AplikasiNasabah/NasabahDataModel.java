...
public class NasabahDataModel {
    ...
    public void addNasabah(Individual nb) throws SQLException{
    ...
    public ObservableList<Individual> getIndividu(){
        ObservableList<Individual> data = FXCollections.observableArrayList();
        ...
        try {
            ...
            while (rs.next()){
                ...
                data.add(new Individual(rs.getString(4), rs.getString(5), rs.getInt(1),
