...
public class NasabahFormController implements Initializable {
    ...
    //----------INDIVIDU---------------
    @FXML
    private TableView<Individual> tblNasabahIndi;

    @FXML
    private TableColumn<Individual, Integer> colIdNasabahIndi;

    @FXML
    private TableColumn<Individual, String> colNamaIndi;

    @FXML
    private TableColumn<Individual, String> colAlamatIndi;

    @FXML
    private TableColumn<Individual, String> colNikIndi;

    @FXML
    private TableColumn<Individual, String> colNpwpIndi;
    ...
    void handleMuatUlangIndiBtn(ActionEvent event) {
        ObservableList<Individual> data = ndm.getIndividu();
    ...
    void handleTambahNbIndiBtn(ActionEvent event) {
        Individual nb = new Individual(tfNikIndi.getText(), tfNpwpIndi.getText(), 
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tblNasabahIndi.getSelectionModel().selectedIndexProperty().addListener(listener->{
            if (tblNasabahIndi.getSelectionModel().getSelectedItem()!=null){
                Individual nb = tblNasabahIndi.getSelectionModel().getSelectedItem();
